...
public class ElasticsearchConvention extends Convention.Impl {
  ...
  public ElasticsearchConvention(SqlDialect dialect, Expression expression,
      String name) {
    super("Elasticsearch." + name, ElasticsearchRel.class);
    this.dialect = dialect;
    this.expression = expression;
  }

  public static ElasticsearchConvention of(SqlDialect dialect, Expression expression,
      String name) {
    return new ElasticsearchConvention(dialect, expression, name);
  }
...
// End ElasticsearchConvention.java
